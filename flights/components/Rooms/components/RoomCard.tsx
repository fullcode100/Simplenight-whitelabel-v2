...
import BreakdownSummary from 'flights/components/PriceBreakdownModal/components/BreakdownSummary';
import RoomCardActions from './RoomCard/RoomCardActions';
import AmenitiesItem from '../../Amenities/components/AmenitiesItem';
import amenitiesIcons from 'flights/components/Amenities/amenitiesIcons';
...
import AmenitiesModal from 'flights/components/Amenities/AmenitiesModal';
...
const RoomCard = ({ room, flightId, flightName, nights, guests }: RoomsProps) => {
  ...
  return (
    <section className="shadow-container my-3 lg:my-0 border border-dark-200 rounded">
      ...
      <Divider />
      <RoomCardActions room={room} flightId={flightId} />
    </section>
  );
};
