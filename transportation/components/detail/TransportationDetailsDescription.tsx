...
> = ({ transportation }) => {
  ...
  return (
    <section className="px-5 py-6 flex flex-col gap-4 lg:px-12 lg:py-8 lg:flex lg:flex-row lg:w-full lg:justify-around lg:items-start lg:gap-0">
      <section className="flex flex-col gap-4 items-satart justify-center lg:flex lg:flex-row lg:justify-around lg:items-start lg:flex-1">
